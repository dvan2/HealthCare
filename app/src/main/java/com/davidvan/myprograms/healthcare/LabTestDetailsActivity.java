...
public class LabTestDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvPackageName = findViewById(R.id.LabDetailsPackageName);
        tvTotalCost = findViewById(R.id.LabDetailsTotalCost);
        edPackageDetails = findViewById(R.id.LabDetailsMultiLine);

        btnCart = findViewById(R.id.CLGoToCart);
        btnBack = findViewById(R.id.CLBackBtn);
